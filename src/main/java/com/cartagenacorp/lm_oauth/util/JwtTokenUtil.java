...
public class JwtTokenUtil {
    ...
    public String generateToken(String userId, String email, String givenName, String familyName, String picture, String role, List<String> permissions, UUID organizationId) {
